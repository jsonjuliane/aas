...
# Keyword path (Vosk offline first; Google fallback only when engine=auto and Vosk is unavailable)
VOICE_KEYWORD_ENGINE = "auto"  # auto | vosk | google
...
VOICE_KEYWORD_MIN_RMS = 6500  # skip keyword recognition below this (idle p95 ~6.2k on bench USB mic)
